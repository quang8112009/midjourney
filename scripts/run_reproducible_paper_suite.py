...
def main():
    ...
    # 4. Master Consolidated Table
    print("\n\n4. MASTER CONSOLIDATED TECHNICAL PAPER RESULTS TABLE")
    print("-" * 110)
    print(f"{'Dimension / Metric':<30} | {'SD v1.5 (UNet+CLIP)':<24} | {'PixArt-A (DiT+T5)':<24} | {'SD 3.5 M (MMDiT+T5)':<24}")
    print("-" * 110)
    print(f"{'Aesthetic (LAION v2.4)':<30} | {sd15_data['laion_aesthetic_v2_4']['off_mean']:.3f} +- {sd15_data['laion_aesthetic_v2_4']['off_seed_std']:.3f}{'':<10} | {pixart_data['laion_aesthetic_v2_4']['off_mean']:.3f} +- {pixart_data['laion_aesthetic_v2_4']['off_seed_std']:.3f}{'':<10} | {sd35_data['laion_aesthetic_v2_4']['off_mean']:.3f} +- {sd35_data['laion_aesthetic_v2_4']['off_seed_std']:.3f}")
