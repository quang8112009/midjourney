...
\midrule
\textbf{Prompt Descriptor Expansion} & $+0.0831$ LAION ($p = 2.18\times 10^{-5}$) & $-0.0468$ ImageReward (Wilcoxon $p = 0.0009$) & $+0.0343$ LAION (Wilcoxon $p = 0.1630$, Flat) \\
